...
export interface PostData {
    ...
    readTime: string;
    image: string;
    fullContent: string | JSX.Element; // Can be a string of Markdown or JSX
  }
  ...
  export const posts: PostData[] = [
    ...
    },
    {
      ...
      fullContent: `
        <div class="prose prose-lg max-w-none">
          <p>My Main Unraid server (192.168.1.144) is the workhorse of my homelab, and Docker is at the heart of its service delivery. Leveraging Unraid's user-friendly Docker management and Community Applications plugin, I host a wide array of services.</p>
    ...
    },
    {
      ...
      fullContent: `
        <div class="prose prose-lg max-w-none">
          ...
          <p>The UPS status can be monitored through Unraid's interface and logs. The last logged status was "COMMLOST," which usually indicates a communication issue (e.g., USB cable disconnected temporarily, server was off, or the apcupsd service was stopped/restarted). Regular checks are important to ensure the monitoring is active.</p>
          <p>The detailed log (APC ID: 001,017,0432, HOSTNAME: moneymaker, VERSION: 3.14.14 slackware) provides granular information about UPS events and status over time.</p>
